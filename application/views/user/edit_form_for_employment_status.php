                    ...
                    <div class="rowme"> -->
                      <hr style="width:1130px; margin-left:80px">
                        <div class="button_field">
                            ...
                            <button type="button" class="btn btn-info" id="cancel_employeement_status_update">Cancel</button>&nbsp;&nbsp;     
...
//alert ($(this).attr('id'));    
 ...
 $("#cancel_employeement_status_update").click(function(){
  $("#update_div").html("");
 }) ;
...
$('tr').click(function(){      $('tr').removeClass("highlight_line");
 ...
 $("#update").click(function(){
     ...
     $.post("index.php/admin_ctrl/show_update_form_for_employment_status",
      {id:$("#id_field").val(),job_category_name:$("#name_field").val()},
      function(data){ $("#update_div").html(data);employment_status_detail();
      });
   }); 
 ...
 $("#delete_data").click(function(){
     ...
     $.post("index.php/admin_ctrl/delete_data_for_employment_status",
      {id:$("#id_field").val()},
      function(data){ $("#update_div").html(data);employment_status_detail();
      });
   }); 
