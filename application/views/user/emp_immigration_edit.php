                    ...
                    <legend></legend>
                         <div class="row_content_left_for_user">
                              <div class="row_content_left_left">
                                   <div class="name_field_for_user">
                                        <div class="checkbox_field"><input type="radio" id="im_document_pass" name="im_document" value="PASSPORT" checked="checked" /></div>
                        ...
                        <div class="row_content_right_for_user">
                         ...
                         <div class="row_content_left_for_user">
                              ...
                              <div class="row_content_left_right">
                                         <input type="text" class="span4me" id="im_numbr" name="im_numbr"  value="<?php echo $im_numbr; ?>" />
                              </div>
                              ...
                              <div class="row_content_left_right">
                                      <input type="text" class="span4me" id="im_issue_date" name="im_issue_date"  value="<?php echo $im_issue_date; ?>" size="18">
                              </div>
                              <div class="row_content_left_left_less">
                                  <div class="name_field_for_user">
                                     <b>Expiry Date :</b>
                              ...
                              <div class="row_content_left_right">
                                      <input type="text" class="span4me" id="im_expiry_date" name="im_expiry_date"  value="<?php echo $im_expiry_date; ?>">
                              </div>                                                                                                       
                        </div><!--row_content_left_for_user-->
                        ...
                        <div class="row_content_right_for_user">
                              ...
                              <div class="row_content_left_right">
                                      <input type="text" class="span4me" id="im_eligible" name="im_eligible"  value="<?php echo $im_eligible; ?>" />
                              </div>
                              <div class="row_content_left_left_less">
                                  <div class="name_field_for_user">
                                     <b>Issued By :</b>
                              ...
                              <div class="row_content_left_right">
                                       <input type="text" class="span4me" id="im_review_date" name="im_review_date" value="<?php echo $im_review_date; ?>" size="18">
                              </div>                                                                              
                        </div><!--row_content_right_for_user-->

                        <textarea id="im_comment" name="comment" placeholder="<?php echo $im_comment; ?>"></textarea>
    
                         
          <legend></legend>
    <label>
      <button class="btn btn-primary button_medium_width " id="immig_updatebtn">
      <i class="icon-eye-open icon-white"></i><strong> Update</strong></button>                
        </label>
...
<script type="text/javascript">
  $(function()
  {
   ...
   $("#immig_updatebtn").click(function(){
      wait();
      ...
      if($("#im_numbr").val()!='')
      {
        ...
        $.post("emp_immigration_update_ctrl",{document_name:$('input[name=im_document]:checked').val(),im_numbr:$("#im_numbr").val(),im_issue_date:$("#im_issue_date").val(),im_expiry_date:$("#im_expiry_date").val(),im_eligible:$("#im_eligible").val(),im_issuedby:$("#im_issuedby").val(),im_review_date:$("#im_review_date").val(),im_comment:$("#im_comment").val()},
